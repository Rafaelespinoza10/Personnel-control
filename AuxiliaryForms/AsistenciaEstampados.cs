...
namespace PEASA_App
{
    public partial class AsistenciaEstampados : Form
    {
        ...
        public AsistenciaEstampados(MySQLConnectionManager connectionManager)
        {
            InitializeComponent();
        ...
        private void AsistenciaEstampados_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarListaTrabajadores()
        {
            try
            {
                DataTable workersData = workersDataBase.GetAttandanceEstampadosList();
