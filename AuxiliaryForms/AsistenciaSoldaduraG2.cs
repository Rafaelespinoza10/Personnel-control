...
namespace PEASA_App
{
    public partial class AsistenciaSoldaduraG2 : Form
    {
        ...
        public AsistenciaSoldaduraG2(MySQLConnectionManager connectionManager)
        {
            InitializeComponent();
        ...
        private void MostrarListaTrabajadores()
        {
            try
            {
                DataTable workersData = workersDataBase.GetAttandanceSoldaduraList2();
        ...
        private void btn_ConfirmarAsistencia_Click_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void AsistenciaSoldaduraG2_Load(object sender, EventArgs e)
        {
