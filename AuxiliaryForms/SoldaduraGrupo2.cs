...
namespace PEASA_App
{
    public partial class SoldaduraGrupo2 : Form
    {
        ...
        public SoldaduraGrupo2(MySQLConnectionManager connectionManager)
        {
            InitializeComponent();
        ...
        private void ActualizarListaAsistencia()
        {
            try
            {
                DataTable dataTable = workersDataBase.GetAttandanceSoldaduraList2();
                if (dataTable != null)
                {
        ...
        private void SoldaduraGrupo2_Load(object sender, EventArgs e)
        {
