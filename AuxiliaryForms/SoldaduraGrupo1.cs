...
namespace PEASA_App
{
    public partial class SoldaduraGrupo1 : Form
    {
        ...
        public SoldaduraGrupo1(MySQLConnectionManager connectionManager)
        {
            InitializeComponent();
        ...
        private void ActualizarListaAsistencia()
        {
            try
            {
                DataTable dataTable = workersDataBase.GetAttandanceSoldaduraList();
                if (dataTable != null)
                {
        ...
        private void SoldaduraGrupo1_Load(object sender, EventArgs e)
        {
