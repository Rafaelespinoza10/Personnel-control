...
namespace PEASA_App
{
    public partial class AsistenciaSoldaduraG3 : Form
    {
        ...
        public AsistenciaSoldaduraG3(MySQLConnectionManager connectionManager)
        {
            InitializeComponent();
        ...
        private void MostrarListaTrabajadores()
        {
            try
            {
                DataTable workersData = workersDataBase.GetAttandanceSoldaduraList3();
        ...
        private void AsistenciaSoldaduraG3_Load(object sender, EventArgs e)
        {
