...
namespace PEASA_App
{
    public partial class AltaTrabajadoresSoldadura : Form
    {
        private MySQLConnectionManager connectionManager;
        private MySQLQueryManager queryManager;
        private WorkersDataBase workersDataBase;
        public event EventHandler<TrabajadorEvents> NewWorkerSoldadura;

        protected virtual void OnWorkerAdd(TrabajadorEvents e) // agregar workerEvents
        {
            NewWorkerSoldadura?.Invoke(this, e);
        }
            public AltaTrabajadoresSoldadura(MySQLConnectionManager connectionManager)
        {
            InitializeComponent();
        ...
        private int ObtainGerentID(string gerent)
        {
            ...
            {
                { "Oscar Jara", "oscar.jara" },
                { "Osvaldo Andraca", "osvaldo.andraca" },
                { "David Aranda", "david.aranda" }
        ...
        private void btn_addSoldaduraWorker_Click(object sender, EventArgs e)
        {
